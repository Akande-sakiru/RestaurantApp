                ...
                onSuccess: async (response) => {
                    ...
                    try {
                        ...
                        if (verifyResult.status) {
                            ...
                            router.get(`/orders/${paymentData.order_id}/confirmation`, {}, {
                                preserveScroll: true,
                            });
                        } else {
                        ...
                        <Card>
                            ...
                            <CardBody className="space-y-4">
                                <p className="text-sm text-gray-600 mb-4">
                                    Paystack securely processes all payment methods
                                </p>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-xs text-blue-700 mt-1">
                                Your payment information is encrypted and processed securely by Paystack
                            </p>
                        </div>
                    </motion.div>
                </div>
                        ...
                        <Card>
                            ...
                            <CardBody className="space-y-6">
                                ...
                                {isInitializing && (
                                    ...
                                    >
                                        <Loader size={24} className="mx-auto text-blue-600 animate-spin mb-2" />
