...
Route::middleware(['auth', 'verified', 'role:admin'])
    ...
    ->group(function () {
        ...
        Route::get('/menu-items/{menuItem}/edit', [\App\Http\Controllers\Admin\MenuItemController::class, 'update'])->name('menu-items.edit');
        Route::patch('/menu-items/{menuItem}', [\App\Http\Controllers\Admin\MenuItemController::class, 'edit'])->name('menu-items.update');
